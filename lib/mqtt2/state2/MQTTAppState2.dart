...
class MQTTAppState2 with ChangeNotifier {
  ...
  //void setAppConnectionState2(MQTTAppConnectionState2 connecting) {}
  ...
  void setAppConnectionState2(MQTTAppConnectionState2 state2) {
    _appConnectionState2 = state2;
    notifyListeners();
  }
  ...
  MQTTAppConnectionState2 get getAppConnectionState2 => _appConnectionState2;
}
